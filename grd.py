...
'''
    ...
    :copyright: Copyright 2018-2020 Q. Vitale, L. Darras and contributors, see AUTHORS.
    :license: GNU GPL v3.

    Functions
    ---------

    read_grd  -- function to read data from Golden Software Surfer grid format.
    read_surfer7bin  -- function to read data from Golden Software Surfer Surfer 7 binary grid format.
    read_surfer6bin  -- function to read data from Golden Software Surfer Surfer 6 binary grid format.
    read_surfer6ascii  -- function to read data from Golden Software Surfer Surfer 6 ASCII grid format.
    write_grd  -- function to write data to Golden Software Surfer grid format.
    write_surfer7bin  -- function to write data to Golden Software Surfer Surfer 7 binary grid format.
    write_surfer6bin  -- function to write data to Golden Software Surfer Surfer 6 binary grid format.
    write_surfer6ascii  -- function to write data to Golden Software Surfer Surfer 6 ASCII grid format.

'''

__author__ = 'Quentin Vitale'
__date__ = '18/09/2020'
...
GRID_WRITER = {'surfer7bin' : write_surfer7bin,
