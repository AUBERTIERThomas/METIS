...
def GUI_CMDEX_init(from_EXEC=None):
    ...
    label_list = ["uid","file_list","sep","sup_na","regr","l_r","corr_base","no_base","pseudo_prof","l_p"]
    type_list = ["int","str[]","str","bool","bool","int/str[]","bool","bool","bool","float[]"]
    default_list = ["*","None",'\\t',"True","False","None","True","False","False","None"]
